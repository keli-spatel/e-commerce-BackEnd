...
import { DataLoaderModule } from './common/loaders/dataLoader.module';
import { UserLoader } from './modules/user/user.dataLoader';
...
@Module({
  imports: [
    ...
    /// DataLoader registation with their modules
